...
//Pre Auto variables
int Pre = 0; //Varaible for exiting the screen, if it doesn't exit it wont allow any code to run after it
int SideSelect = 0;//Variable for selecting red or blue autos
double Screen = 0; //Keeps track of what screen is current;y being displayed
int subscreen = 0; //Sub Screen for checking if devices are connected
int controllerLine = 0; //Keeps track of the line on the controller screen
int ProgSelect = 0; //Keeps track of which auto has been selected
...
void initialize() {
	...
	while(Pre==0){//Gui initializea
		if(Screen == 0){//Home Screen
			...
			while(Screen == 0){//Home screen
				...
				if(Controller1.get_digital(DIGITAL_A)){
					if(controllerLine == 0){//Confirm button on controller
						pros::screen::erase();
						Controller1.clear();
						pros::delay(150);
						printSelectedAuto();
					...
					if(controllerLine == 1){//Confirm button on controller
						pros::screen::erase();
						Controller1.clear();
						SideSelect = 1;
						Screen = 2;
					...
					if(controllerLine == 2){//Confirm button on controller
						pros::screen::erase();
						Controller1.clear();
						SideSelect = 2;
						Screen = 2;
		...
		if(Screen == 2){ //Program Select Screen
			...
			if(SideSelect == 2){
				Controller1.print(0, 3, "***LN+AG***"); //Print on controller screen to indicate when ready to enter the Program
				pros::delay(50); //Delay to make sure there is no accidental input
				Controller1.print(1, 8, "CNG"); //Print on controller screen to indicate when ready to enter the Program
				pros::delay(50); //Delay to make sure there is no accidental input
				Controller1.print(2, 6, "LF->Center"); //Print on controller screen to indicate when ready to enter the Program
				pros::delay(50); //Delay to make sure there is no accidental input
			}
			...
			while(Screen == 2 ){
				...
				if(SideSelect == 1){
					if(Controller1.get_digital_new_press(DIGITAL_UP)){//Menu
						if(controllerLine == 1){
							...
							Controller1.print(0, 0, "***RN+AG+Rings***"); //Print on controller screen to indicate when ready to enter the Program
							pros::delay(50); //Delay to make sure there is no accidental input
							Controller1.print(1, 6, "Right Spin"); //Print on controller screen to indicate when ready to enter the Program
							pros::delay(50); //Delay to make sure there is no accidental input
							Controller1.print(2, 5, "RF->Center"); //Print on controller screen to indicate when ready to enter the Program
							pros::delay(50); //Delay to make sure there is no accidental input
							controllerLine--;
							...
							Controller1.clear();
							pros::delay(50); //Delay to make sure there is no accidental input
							Controller1.print(0, 4, "RN+AG+Rings"); //Print on controller screen to indicate when ready to enter the Program
							pros::delay(50); //Delay to make sure there is no accidental input
							Controller1.print(1, 2, "***Right Spin***"); //Print on controller screen to indicate when ready to enter the Program
							pros::delay(50); //Delay to make sure there is no accidental input
							Controller1.print(2, 5, "RF->Center"); //Print on controller screen to indicate when ready to enter the Program
							pros::delay(50); //Delay to make sure there is no accidental input
							controllerLine--;
						}
						else if(controllerLine == 3){
							Controller1.clear();
							pros::delay(50); //Delay to make sure there is no accidental input
							Controller1.print(0, 4, "RN+AG+Rings"); //Print on controller screen to indicate when ready to enter the Program
							pros::delay(50); //Delay to make sure there is no accidental input
							Controller1.print(1, 6, "Right Spin"); //Print on controller screen to indicate when ready to enter the Program
							pros::delay(50); //Delay to make sure there is no accidental input
							Controller1.print(2, 1, "***RF->Center***"); //Print on controller screen to indicate when ready to enter the Program
							pros::delay(50); //Delay to make sure there is no accidental input
							controllerLine--;
						}
						else if(controllerLine == 4){
							Controller1.clear();
							pros::delay(50); //Delay to make sure there is no accidental input
							Controller1.print(0, 6, "Right Spin"); //Print on controller screen to indicate when ready to enter the Program
							pros::delay(50); //Delay to make sure there is no accidental input
							Controller1.print(1, 6, "RF->Center"); //Print on controller screen to indicate when ready to enter the Program
							pros::delay(50); //Delay to make sure there is no accidental input
							Controller1.print(2, 0, "***CNG+AG+Rings***"); //Print on controller screen to indicate when ready to enter the Program
							pros::delay(50); //Delay to make sure there is no accidental input
							controllerLine--;
						}
					}
					...
					if(Controller1.get_digital_new_press(DIGITAL_DOWN)){//Menu
						if(controllerLine == 0){
							...
							Controller1.clear();
							pros::delay(50); //Delay to make sure there is no accidental input
							Controller1.print(0, 6, "RF->Center"); //Print on controller screen to indicate when ready to enter the Program
							pros::delay(50); //Delay to make sure there is no accidental input
							Controller1.print(1, 3, "CNG+AG+Rings"); //Print on controller screen to indicate when ready to enter the Program
							pros::delay(50); //Delay to make sure there is no accidental input
							Controller1.print(2, 4, "***CF->RN***"); //Print on controller screen to indicate when ready to enter the Program
							pros::delay(50); //Delay to make sure there is no accidental input
							controllerLine++;
						}
					}
				...
				if(SideSelect == 2){
					if(Controller1.get_digital_new_press(DIGITAL_UP)){//Menu
						if(controllerLine == 1){
							...
							Controller1.clear();
							pros::delay(50); //Delay to make sure there is no accidental input
							Controller1.print(0, 8, "LN+AG"); //Print on controller screen to indicate when ready to enter the Program
							pros::delay(50); //Delay to make sure there is no accidental input
							Controller1.print(1, 5, "***CNG***"); //Print on controller screen to indicate when ready to enter the Program
							pros::delay(50); //Delay to make sure there is no accidental input
							Controller1.print(2, 6, "LF->Center"); //Print on controller screen to indicate when ready to enter the Program
							pros::delay(50); //Delay to make sure there is no accidental input
							controllerLine--;
							...
							Controller1.print(1, 8, "CNG"); //Print on controller screen to indicate when ready to enter the Program
							pros::delay(50); //Delay to make sure there is no accidental input
							Controller1.print(2, 2, "***LF->Center***"); //Print on controller screen to indicate when ready to enter the Program
							pros::delay(50); //Delay to make sure there is no accidental input
							controllerLine--;
						}
						else if(controllerLine == 4){
							Controller1.clear();
							pros::delay(50); //Delay to make sure there is no accidental input
							Controller1.print(0, 8, "CNG"); //Print on controller screen to indicate when ready to enter the Program
							pros::delay(50); //Delay to make sure there is no accidental input
							Controller1.print(1, 6, "LF->Center"); //Print on controller screen to indicate when ready to enter the Program
							pros::delay(50); //Delay to make sure there is no accidental input
							Controller1.print(2, 3, "***Left Spin***"); //Print on controller screen to indicate when ready to enter the Program
							pros::delay(50); //Delay to make sure there is no accidental input
							controllerLine--;
						}
					}
					...
					if(Controller1.get_digital_new_press(DIGITAL_DOWN)){//Menu
						if(controllerLine == 0){
							...
							Controller1.clear();
							pros::delay(50); //Delay to make sure there is no accidental input
							Controller1.print(0, 6, "LF->Center"); //Print on controller screen to indicate when ready to enter the Program
							pros::delay(50); //Delay to make sure there is no accidental input
							Controller1.print(1, 6, "Left Spin"); //Print on controller screen to indicate when ready to enter the Program
							pros::delay(50); //Delay to make sure there is no accidental input
							Controller1.print(2, 4, "***CF->LN***"); //Print on controller screen to indicate when ready to enter the Program
							pros::delay(50); //Delay to make sure there is no accidental input
							controllerLine++;
						}
					}
				...
				if(Controller1.get_digital(DIGITAL_A)){
					if(SideSelect == 1){
						...
						else if(controllerLine == 1){//Confirm button on controller
							ProgSelect = 12;
							pros::screen::erase();
							Controller1.clear();
							pros::delay(150);
						...
						else if(controllerLine == 2){//Confirm button on controller
							ProgSelect = 13;
							pros::screen::erase();
							Controller1.clear();
							pros::delay(150);
						...
						else if(controllerLine == 3){//Confirm button on controller
							ProgSelect = 14;
							pros::screen::erase();
							Controller1.clear();
							pros::delay(150);
						...
						else if(controllerLine == 4){//Confirm button on controller
							ProgSelect = 15;
							pros::screen::erase();
							Controller1.clear();
							pros::delay(150);
