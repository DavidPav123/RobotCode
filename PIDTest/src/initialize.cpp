...
void printSelectedAuto(){ //Function for printing selected auto to the screens
	switch(ProgSelect){
		case 11:
		pros::screen::print(TEXT_LARGE,175,120,"Downside Finals");
		Controller1.print(1, 8, "Downside Finals");
		break;
		case 12:
		pros::screen::print(TEXT_LARGE,175,120,"Downside Rings");
		Controller1.print(1, 8, "Downside Rings");
		break;
		case 13:
		pros::screen::print(TEXT_LARGE,175,120,"Upside Finals");
		Controller1.print(1, 8, "Upside Finals");
		break;
		case 14:
		pros::screen::print(TEXT_LARGE,175,120,"NOT AN AUTO");
		Controller1.print(1, 8, "NOT AN AUTO");
		break;
		case 21:
		pros::screen::print(TEXT_LARGE,175,120,"Upside Rings");
		Controller1.print(1, 8, "Upside Rings");
		break;
		case 22:
		pros::screen::print(TEXT_LARGE,175,120,"Upside Middle");
		Controller1.print(1, 8, "Upside Middle");
		break;
		case 23:
		pros::screen::print(TEXT_LARGE,175,120,"NOT AN AUTO");
		Controller1.print(1, 8, "NOT AN AUTO");
	...
	while(Pre==0){//Gui initializea
		if(Screen == 0){//Home Screen
			...
			while(Screen == 0){//Home screen
				...
				if(Controller1.get_digital(DIGITAL_A) && contollerLine == 0){//Confirm button on controller
					pros::screen::erase();
					Controller1.clear();
					pros::delay(150);
					printSelectedAuto();
